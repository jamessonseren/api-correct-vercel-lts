...
describe("E2E Business tests", () => {
  ...
  //       partner2_info_uuid = result.body.business_info_uuid
  //       partner2_address_uuid = result.body.address_uuid
  ...
  //   //     const result = await request(app).get("/partner/seller").set('Authorization', `Bearer ${correctSellerToken}`).send({document: 'comercio2'})

  //   //     expect(result.statusCode).toBe(200)
  //   //     expect(result.body.business_document).toBe("comercio2")
  ...
  //   //   let partner_document: string
  //   //   let partner_info_uuid: string
  //   //   beforeAll(async () => {
  //   //     const partner = await request(app).get("/partner/seller").set('Authorization', `Bearer ${correctSellerToken}`).send({document: 'comercio2'})
  //   //     partner_document = partner.body.business_document
  //   //     partner_info_uuid = partner.body.business_info_uuid
  //   //   })

  //   //   it("Should throw and error if business uuid is missing", async () => {
  //   //     const input = {
  //   //       business_info_uuid: ''
  //   //     }
  //   //   })
