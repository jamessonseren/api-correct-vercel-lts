...
CREATE TABLE "companies_data" (
    ...
    CONSTRAINT "companies_data_pkey" PRIMARY KEY ("uuid")
);
...
-- CreateIndex
CREATE UNIQUE INDEX "companies_data_document_key" ON "companies_data"("document");
...
-- AddForeignKey
ALTER TABLE "business_users" ADD CONSTRAINT "business_users_business_info_uuid_fkey" FOREIGN KEY ("business_info_uuid") REFERENCES "companies_data"("uuid") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "companies_data" ADD CONSTRAINT "companies_data_address_uuid_fkey" FOREIGN KEY ("address_uuid") REFERENCES "addresses"("uuid") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "companies_data" ADD CONSTRAINT "companies_data_contract_info_uuid_fkey" FOREIGN KEY ("contract_info_uuid") REFERENCES "contract_info"("uuid") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "user_info" ADD CONSTRAINT "user_info_business_info_uuid_fkey" FOREIGN KEY ("business_info_uuid") REFERENCES "companies_data"("uuid") ON DELETE SET NULL ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "benefits" ADD CONSTRAINT "benefits_business_info_uuid_fkey" FOREIGN KEY ("business_info_uuid") REFERENCES "companies_data"("uuid") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "transactions" ADD CONSTRAINT "transactions_business_info_uuid_fkey" FOREIGN KEY ("business_info_uuid") REFERENCES "companies_data"("uuid") ON DELETE RESTRICT ON UPDATE CASCADE;
